...
<body>
    ...
    <div class="container">
        <form action="/addTheatre" method="post">
            <div class="form-group">
                <label for="theatreId">Multiplex ID:</label>
                <input type="text" id="theatreId" name="theatreId" />
            </div>

            <div class="form-group">
                <label for="name">Multiplex Name:</label>
                <input type="text" id="name" name="name" required />
            </div>
            ...
            <div class="form-group">
                <label for="location">Multiplex Location:</label>
                <input type="text" id="location" name="location" required />
            </div>
            ...
            <button type="submit">Add Multiplex</button>
        </form>
    </div>
</body>
</html>
