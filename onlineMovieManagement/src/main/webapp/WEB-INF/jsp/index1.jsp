...
<body>
    ...
    <div class="navbar">
        ...
        <div class="dropdown">
            <button class="dropbtn">Multiplex Management</button>
            <div class="dropdown-content">
        <a href="/addTheatre">Multiplex Addition</a>
<!--         <a href="/updateTheatres">Theater Update</a>
        <a href="/deleteTheatre">Theater Deletion</a> -->
        <a href="/viewDetails">Multiplex Reports</a>
        ...
        <div class="dropdown">
         ...
         <div class="dropdown">
            <button class="dropbtn">Customer List</button>
            <div class="dropdown-content">
                 <a href="/customerList">List of Customer</a>
